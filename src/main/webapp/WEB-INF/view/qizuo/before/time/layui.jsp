    ...
    $(function(){
        layui.use('laydate', function(){
            ...
            var ins1=laydate.render({
                 ...
                 */
                range:'',//开启面板范围 range: true 或 range: '~' 来自定义分割字符
                format:'',//格式
                /**
                 ...
                 * s 	秒数，允许一位数
                 */
                value:'',//初始化值 value: '2018-08-18' 必须遵循format参数设定的格式 / value: new Date(1534766888000) 参数即为：2018-08-20 20:08:08 的时间戳
                isInitValue: false, //是否允许填充初始值，配合value使用
                min: '2017-1-1',//最小值 不在范围内的将不可选中
                max: '2017-12-31',//最大值 不在范围内的将不可选中
                /**
