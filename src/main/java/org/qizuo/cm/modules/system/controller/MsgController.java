...
public class MsgController {
     ...
     */
    @RequestMapping("list")
    public BackResultPoJo list(MsgPoJo msgPoJo,HttpServletRequest httpServletRequest){
        //获取当前登录人
     ...
     */
    @RequestMapping("iuDo")
    public BackResultPoJo insert(HttpServletRequest httpServletRequest, MsgPoJo msgPoJo){
        if(StringUtils.isNotBlank(msgPoJo.getSendUserIds())){
            ...
            if(null!=sendUserIdAr&&sendUserIdAr.length>0){
                ...
                //插入准备
                msgPoJo.preIDo(httpServletRequest);
