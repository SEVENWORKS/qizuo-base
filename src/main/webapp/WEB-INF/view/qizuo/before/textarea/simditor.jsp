...
<script>
    $(function(){
        document.writeln("<script src=\"${staticPath}js/simditor/module.js\"><\/script>");
        document.writeln("<script src=\"${staticPath}js/simditor/hotkeys.js\"><\/script>");
        document.writeln("<script src=\"${staticPath}js/simditor/uploader.js\"><\/script>");
        //引入js
