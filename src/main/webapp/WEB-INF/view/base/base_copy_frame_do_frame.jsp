...
<div class="block-area m-b-10">
	...
	<div class="row col-lg-12 m-b-30">
		<h2>img</h2>
		<!-- 正方形，带圆角 -->
		<img src="${staticPath}img/base/images-doc/rounded.png" class="img-rounded m-r-10 m-b-10" alt="">
		<!-- 圆形 -->
		<img src="${staticPath}img/base/images-doc/circle.png" class="img-circle m-r-10 m-b-10" alt="">
		<!-- 正方形 -->
		<img src="${staticPath}img/base/images-doc/thumbnail.png" class="img-thumbnail m-r-10 m-b-10" alt="">
		<!-- 有阴影的圆形 -->
		<img src="${staticPath}img/base/images-doc/shadowed.png" class="img-circle img-shadowed m-b-10" alt="">
	</div>
...
<div class="block-area m-b-10">
	...
	<a href="${staticPath}img/base/gallery/1.jpg" data-rel="gallery"  class="pirobox_gall img-popup" title="Lovely evening in Noreway">
		<img src="${staticPath}img/base/gallery/thumbs/1.jpg" alt="" width="150">
	</a>

	<p class="m-t-20">Image Album (Click to open)</p>
	<a href="${staticPath}img/base/gallery/1.jpg" data-rel="gallery"  class="pirobox_gall img-popup" title="Fusce sagittis porta porttitor aliquam tincidunt auctor nibh non convallis">
		<img src="${staticPath}img/base/gallery/thumbs/1.jpg" alt="">
	</a>
	<a href="${staticPath}img/base/gallery/2.jpg" data-rel="gallery"  class="pirobox_gall img-popup" title="Sed ultrices orci iaculis augue tincidunt gravida">
		<img src="${staticPath}img/base/gallery/thumbs/2.jpg" alt="">
	</a>
	<a href="${staticPath}img/base/gallery/3.jpg" data-rel="gallery"  class="pirobox_gall img-popup" title="Donec ullamcorper malesuada magna mollis pellentesque">
		<img src="${staticPath}img/base/gallery/thumbs/3.jpg" alt="">
	</a>
	<a href="${staticPath}img/base/gallery/4.jpg" data-rel="gallery"  class="pirobox_gall img-popup" title="Aliquam tincidunt auctor nibh non convallis">
		<img src="${staticPath}img/base/gallery/thumbs/4.jpg" alt="">
	</a>
	<a href="${staticPath}img/base/gallery/5.jpg" data-rel="gallery"  class="pirobox_gall img-popup" title="Quelorem venenatis aliquet enim non venenatis">
		<img src="${staticPath}img/base/gallery/thumbs/5.jpg" alt="">
	</a>
	...
	<div id="carousel-example-generic" class="carousel slide">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="${staticPath}img/base/carousel/c-1.jpg" alt="Slide-1">
			</div>
			<div class="item">
				<img src="${staticPath}img/base/carousel/c-2.jpg" alt="Slide-2">
			...
			<div class="item">
				<img src="${staticPath}img/base/carousel/c-3.jpg" alt="Slide-3">
				<div class="carousel-caption hidden-xs">
					<h3>This is a Caption</h3>
					<p>Sample detail text here</p>
				</div>
	...
	<div class="row">
		<div class="col-md-6 m-b-20">
			...
			<video width="100%" height="100%" id="multiCodec" poster="${staticPath}img/base/media-player/media-player-poster.jpg" controls="controls" preload="none"> <!-- id could be any according to you -->
				...
				<object width="100%" height="100%" type="application/x-shockwave-flash" data="${staticPath}media/flashmediaelement.swf">
					...
					<param name="flashvars" value="controls=true&amp;poster=../img/base/media-player/media-player-poster.jpg&amp;file=media/echohereweare.mp4" />
					<!-- Image fall back for non-HTML5 browser with JavaScript turned off and no Flash player installed -->
					<img src="${staticPath}img/base/media-player/media-player-poster.jpg" width="100%" height="100%" alt="Media" title="No video playback capabilities" />
				</object>
			</video>
		</div>
...
<div class="block-area m-b-10">
	...
	<div class="listview list-container">
		...
		<div class="media">
			<input type="checkbox" class="pull-left list-check" value="">
			<img class="media-object pull-left" src="../img/base/profile-pics/1.jpg" alt="" width="45">
			<div class="media-body">
				Nulla vel metus scelerisque ante sollicitudin commodo purus odio.
				<div class="clearfix"></div>
				<small>Lorem ipsum dolor sit amet, per cu solet docendi</small>
		...
		<div class="media">
			<input type="checkbox" class="pull-left list-check" value="">
			<img class="media-object pull-left" src="../img/base/profile-pics/5.jpg" alt="" width="45">
			<div class="media-body">
		...
		<div class="media">
			<input type="checkbox" class="pull-left list-check" value="">
			<img class="media-object pull-left" src="../img/base/profile-pics/2.jpg" alt="" width="45">
			<div class="media-body">
				Per an error perpetua, fierent fastidii recteque ad pro. Mei id brute intellegam
				<div class="clearfix"></div>
				<small> An erant explicari salutatus duo, sumo doming delicata in cum. Eos at augue viderer principes</small><br>
