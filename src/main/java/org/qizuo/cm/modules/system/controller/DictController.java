...
public class DictController {
    ...
    public BackResultPoJo page(PagePoJo<DictPoJo> poJos,DictPoJo dictPoJo){
        ...
        return new BackResultPoJo(BackResultPoJo.SUCCESS,"获取成功",dictService.qPageFL(poJos));
    }
     ...
     */
    @RequestMapping("iuDo")
    public BackResultPoJo iuDo(HttpServletRequest httpServletRequest,DictPoJo dictPoJo){
        //插入或者更新
        dictService.iuBatch(dictPoJo,httpServletRequest);
